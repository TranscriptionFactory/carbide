...
| Sections query: title contains | _(empty)_           | Add heading sections whose title contains this string. Empty disables the section pool.                                                                   |
| Sections query: level          | `Any`               | Keep only `H1`, `H2`, or `H3` sections.                                                                                                                   |
| Sections query: under heading  | _(empty)_           | Keep only sections under this heading path, e.g. `Project A/Tasks`.                                                                                       |

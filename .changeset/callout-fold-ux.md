...
- **Collapsed callouts can always be reopened**: `foldable: false` callouts (markdown-parsed and turn-into) previously could not be opened once collapsed. The `foldable` gate now applies only to *collapsing*, never to opening.

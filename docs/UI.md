...
This document defines the design system, conventions, and standards for carbide's user interface. Follow these guidelines when adding or updating UI components.

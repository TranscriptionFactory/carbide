...
names the harness protocol the CLI speaks (Claude Code, Codex, opencode, or pi); a plain CLI — e.g.
...
loop, _full access_ for a harness agent (Claude Code, Codex, opencode, or pi) with system access. Opening

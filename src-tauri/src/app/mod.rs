    ...
    () => {{
        ...
        #[cfg(feature = "full")]
        {
            tauri::generate_handler![
                ...
                // search (linked notes - references)
...
pub fn run() {
    ...
    {
        builder = builder.manage(features::search::embeddings::EmbeddingServiceState::default());
    }
    ...
    {
        builder = builder.manage(features::toolchain::service::ToolchainState::default());
    }

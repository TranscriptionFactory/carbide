...
export const BUILTIN_NEON_DARK: Theme = {
  ...
  token_overrides: {
    ...
    "--accent-hover": "oklch(0.17 0.03 280)",
...
export const BUILTIN_PAPER_DARK: Theme = {
  ...
  token_overrides: {
    ...
    "--accent-hover": "oklch(0.28 0.02 55)",
...
export const BUILTIN_GLASS_DARK: Theme = {
  ...
  token_overrides: {
    ...
    "--accent-hover": "oklch(0.25 0 0 / 60%)",

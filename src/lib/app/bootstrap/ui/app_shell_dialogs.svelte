...
<TabCloseConfirmDialog
  ...
  has_conflict={stores.ui.tab_close_confirm.has_conflict}
  on_save={() =>
  ...
  on_overwrite={() =>
    void action_registry.execute(ACTION_IDS.tab_confirm_close_overwrite)}
...
<HelpDialog
  ...
  guide={stores.ui.help_dialog.guide}
  hotkeys_config={stores.ui.hotkeys_config}

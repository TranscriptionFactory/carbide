...
export const makeBook = async file => {
    ...
    if (file.isDirectory) {
        ...
        // Carbide patch: EPUB-only. Upstream also dispatches CBZ/FB2/PDF/MOBI
        // here; those format adapters are intentionally not vendored (see
        // README), so only the zip→EPUB path remains.

...
export const COMMANDS_REGISTRY: CommandDefinition[] = [
  ...
  },
  {
    id: "print_pdf",
    label: "Export as PDF",
    description: "Export with rendered diagrams via print dialog",
    keywords: ["export", "pdf", "print", "mermaid", "diagram", "download"],
    icon: "file-down",
  ...
  },
  {
    ...
    description: "Export the current note as a text-only PDF file",
    keywords: ["export", "pdf", "save", "text"],
    icon: "file-down",
    when: (ctx) => ctx.has_open_note,
  },
  {

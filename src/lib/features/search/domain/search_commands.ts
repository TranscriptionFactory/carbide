...
export const COMMANDS_REGISTRY: CommandDefinition[] = [
  ...
  },
  {
    ...
    description: "Insert a live query block that lists matching notes",
    keywords: ["query", "block", "smart", "live", "embed", "insert", "list"],
    icon: "search",
    when: (ctx) => ctx.has_open_note,
  },
  {
    ...
    description: "Insert an embedded bases view driven by a query",
    keywords: [
      "base",
      "bases",
      "block",
  ...
  {
    id: "insert_backlinks_block",
    label: "Insert Backlinks Block",
    description: "Insert a live block listing notes that link here",
    keywords: ["backlinks", "links", "block", "smart", "embed", "insert"],
    icon: "link",
    when: (ctx) => ctx.has_open_note,
  },
  {
    id: "iwe_extract_section",
    label: "IWE: Extract Section",
    description: "Extract the current section into a new linked document",
    keywords: ["iwe", "extract", "section", "refactor", "split"],
    icon: "list-tree",
  },
  {
    id: "iwe_extract_all",
    label: "IWE: Extract All Subsections",
    description: "Extract all child sections into separate linked documents",
    keywords: ["iwe", "extract", "all", "subsections", "refactor"],
    icon: "list-tree",
  },
  {
    id: "iwe_inline_section",
    label: "IWE: Inline as Section",
    description: "Embed referenced document content inline as a section",
    keywords: ["iwe", "inline", "section", "embed", "merge"],
    icon: "list-tree",
  },
  {
    id: "iwe_inline_quote",
    label: "IWE: Inline as Quote",
    description: "Embed referenced document content as a blockquote",
    keywords: ["iwe", "inline", "quote", "blockquote", "embed"],
    icon: "list-tree",
  },
  {
    id: "iwe_list_to_sections",
    label: "IWE: List to Sections",
    description: "Convert a list hierarchy into markdown headers",
    keywords: ["iwe", "list", "sections", "convert", "refactor"],
    icon: "list-tree",
  },
  {
    id: "iwe_section_to_list",
    label: "IWE: Section to List",
    description: "Convert markdown headers into a bullet list",
    keywords: ["iwe", "section", "list", "convert", "refactor"],
    icon: "list-tree",
  },
  {
    id: "iwe_sort_list",
    label: "IWE: Sort List",
    description: "Alphabetize list items at the cursor",
    keywords: ["iwe", "sort", "list", "alphabetize", "order"],
    icon: "list-tree",
  },
  {
    id: "iwe_create_link",
    label: "IWE: Create Link",
    description:

...
export const COMMAND_TO_ACTION_ID: Record<CommandId, string> = {
  ...
  insert_query_block: ACTION_IDS.smart_block_insert_query,
  insert_base_view: ACTION_IDS.smart_block_insert_base,
  insert_backlinks_block: ACTION_IDS.smart_block_insert_backlinks,

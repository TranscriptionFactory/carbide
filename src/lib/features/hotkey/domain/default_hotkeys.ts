...
export const DEFAULT_HOTKEYS: HotkeyBinding[] = [
  ...
  {
    action_id: ACTION_IDS.editor_fold_toggle,
    key: "CmdOrCtrl+Shift+[",
    phase: "bubble",
    label: "Toggle Heading Fold",
    description: "Collapse or expand the heading at cursor",
    category: "editing",
  },
  {
    action_id: ACTION_IDS.editor_fold_collapse_all,
    key: "CmdOrCtrl+Alt+[",
    phase: "capture",
    label: "Collapse All Headings",
    description: "Collapse all heading sections in the note",
    category: "editing",
  },
  {
    action_id: ACTION_IDS.editor_fold_expand_all,
    key: "CmdOrCtrl+Alt+]",
    phase: "capture",
    label: "Expand All Headings",
    description: "Expand all collapsed heading sections",
    category: "editing",
  },
  {

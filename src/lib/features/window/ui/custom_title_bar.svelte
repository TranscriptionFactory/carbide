<script lang="ts">
  ...
  const RESIZE_HANDLES: ReadonlyArray<{
  ...
  }> = [
    {
      direction: "North",
      cursor: "ns-resize",
      style: `top:0;left:${RESIZE_EDGE}px;right:${RESIZE_EDGE}px;height:${RESIZE_EDGE}px`,
    },
    {
      direction: "South",
      cursor: "ns-resize",
      style: `bottom:0;left:${RESIZE_EDGE}px;right:${RESIZE_EDGE}px;height:${RESIZE_EDGE}px`,
    },
    {
      direction: "East",
      cursor: "ew-resize",
      style: `top:${RESIZE_EDGE}px;right:0;bottom:${RESIZE_EDGE}px;width:${RESIZE_EDGE}px`,
    },
    {
      direction: "West",
      cursor: "ew-resize",
      style: `top:${RESIZE_EDGE}px;left:0;bottom:${RESIZE_EDGE}px;width:${RESIZE_EDGE}px`,
    },
    {
      direction: "NorthEast",
      cursor: "nesw-resize",
      style: `top:0;right:0;width:${RESIZE_EDGE}px;height:${RESIZE_EDGE}px`,
    },
    {
      direction: "NorthWest",
      cursor: "nwse-resize",
      style: `top:0;left:0;width:${RESIZE_EDGE}px;height:${RESIZE_EDGE}px`,
    },
    {
      direction: "SouthEast",
      cursor: "nwse-resize",
      style: `bottom:0;right:0;width:${RESIZE_EDGE}px;height:${RESIZE_EDGE}px`,
    },
    {
      direction: "SouthWest",
      cursor: "nesw-resize",
      style: `bottom:0;left:0;width:${RESIZE_EDGE}px;height:${RESIZE_EDGE}px`,
    },
  ];
      ...
      >
        {#if maximized}
          ...
          >
            ...
            <path
              d="M3.5 3.5V2.5a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-.5.5H9.5"
            />
          </svg>
        {:else}
          <svg
